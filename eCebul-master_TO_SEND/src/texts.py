...
Я, [ім'я прізвище в паспорті], звертаюсь до вас з проханням \
...
PASSPORT = """
<b>ПАСПОРТ
ГРОМАДЯНИНА ЦЕБУЛЕВОЇ РЕСПУБЛІКИ</b>
...
Щоб приймати участь у виборах, перейдіть в бота і зареєструйтесь <code>!балотуватися</code>. 
