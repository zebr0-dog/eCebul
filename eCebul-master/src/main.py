...
if __name__ == "__main__":
    ...
    dp.register_message_handler(
        handlers.shop.create_shop.create_shop,
        is_passport_exist=True,
        commands="створити_магазин",
        commands_prefix="!",
        level_of_right=3,
        chat_type="private",
    )
    dp.register_message_handler(
        handlers.shop.create_shop.get_owner_id,
        state=states.CreateShop.shop_owner_id
    )
    dp.register_message_handler(
        handlers.shop.create_shop.get_title,
        state=states.CreateShop.shop_title
    )
    dp.register_message_handler(
        handlers.shop.create_shop.get_message,
        state=states.CreateShop.default_message
    )
    dp.register_message_handler(
        handlers.shop.create_shop.get_fund,
        state=states.CreateShop.shop_fund
    )
    dp.register_message_handler(
        handlers.shop.create_item.createitem,
        is_passport_exist=True,
        commands="завезти",
        commands_prefix="!",
        chat_type="private",
    ...
    dp.register_message_handler(
        handlers.shop.create_item.get_s_id,
        state=states.CreateItem.shop_id
    )
    dp.register_message_handler(
        handlers.shop.create_item.get_name,
        state=states.CreateItem.item_name
    )
    dp.register_message_handler(
        handlers.shop.create_item.get_count,
        state=states.CreateItem.item_count
    )    
    dp.register_message_handler(
        handlers.shop.create_item.get_desc,
        state=states.CreateItem.description
    )    
    dp.register_message_handler(
        handlers.shop.create_item.get_cost,
        state=states.CreateItem.item_cost
    )    
    dp.register_message_handler(
        handlers.shop.create_item.get_status,
        state=states.CreateItem.item_status
    )
